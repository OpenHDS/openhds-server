...
@Controller
@RequestMapping("/individuals2")
public class IndividualResourceApi2 {
    private static final Logger logger = LoggerFactory.getLogger(IndividualResourceApi2.class);
    private IndividualService individualService;
    private FileResolver fileResolver;

    @Autowired
    public IndividualResourceApi2(IndividualService individualService, FileResolver fileResolver) {
