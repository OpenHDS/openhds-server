    ...
    implements Serializable
{
    ...
    @ManyToOne(fetch = FetchType.LAZY, targetEntity = org.openhds.domain.Individual.class)
    @Description(description = "The individual's mother, identified by the external id.")
    private org.openhds.domain.Individual mother;
    ...
    private org.openhds.domain.Individual father;
    ...
    public org.openhds.domain.Individual getMother() {
        return mother;
    }

    public void setMother(org.openhds.domain.Individual mom) {
        mother = mom;
    }

    public org.openhds.domain.Individual getFather() {
        return father;
    }

    public void setFather(org.openhds.domain.Individual dad) {
        father = dad;
    }
