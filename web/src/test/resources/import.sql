...
INSERT INTO individual(uuid,extId,firstName,middleName,lastName,religion,gender,dob,mother_uuid,father_uuid,insertBy_uuid,insertDate,status,dobAspect,voidDate,voidReason,voidBy_uuid,deleted,collectedBy_uuid) VALUES('Unknown Individual','UNK','Unknown',NULL,'UNKNOWN','UNK','M', '1900-12-19', NULL, NULL,'User 1','2009-12-19','P','1',NULL,NULL,NULL,false,'UnknownFieldWorker')
INSERT INTO individual(uuid,extId,firstName,middleName,lastName,religion,gender,dob,mother_uuid,father_uuid,insertBy_uuid,insertDate,status,dobAspect,voidDate,voidReason,voidBy_uuid,deleted,collectedBy_uuid) VALUES ('Individual2','NBAS1I','Nancy',NULL,'Bassey','UNK','F', '1959-12-19', 'Unknown Individual', 'Unknown Individual','User 1','2009-12-19','P','1',NULL,NULL,NULL,false,'FieldWorker1')
INSERT INTO individual(uuid,extId,firstName,middleName,lastName,religion,gender,dob,mother_uuid,father_uuid,insertBy_uuid,insertDate,status,dobAspect,voidDate,voidReason,voidBy_uuid,deleted,collectedBy_uuid) VALUES ('Individual3','BJOH1J','Bob',NULL,'Johnson','UNK','M', '1965-12-19', 'Unknown Individual', 'Unknown Individual','User 1','2009-12-19','P','1',NULL,NULL,NULL,false,'FieldWorker1')
INSERT INTO individual(uuid,extId,firstName,middleName,lastName,religion,gender,dob,mother_uuid,father_uuid,insertBy_uuid,insertDate,status,dobAspect,voidDate,voidReason,voidBy_uuid,deleted,collectedBy_uuid) VALUES ('Individual4','CBLA1H','Cristen',NULL,'Blake','UNK','F', '1960-12-19', 'Unknown Individual', 'Unknown Individual','User 1','2009-12-19','P','1',NULL,NULL,NULL,false,'FieldWorker1')
INSERT INTO individual(uuid,extId,firstName,middleName,lastName,religion,gender,dob,mother_uuid,father_uuid,insertBy_uuid,insertDate,status,dobAspect,voidDate,voidReason,voidBy_uuid,deleted,collectedBy_uuid) VALUES ('Individual5','BHAR1K','Brian',NULL,'Blake','UNK','M', '1965-12-19', 'Unknown Individual', 'Unknown Individual','User 1','2009-12-19','P','1',NULL,NULL,NULL,false,'FieldWorker1')
...
INSERT INTO location(uuid,extId,locationName,locationLevel_uuid,locationType,insertDate,voidReason,voidBy_uuid,deleted,collectedBy_uuid,insertBy_uuid,status) VALUES ('LOCATION1','NJA000001','House 3','hierarchy_root','RUR','2000-12-19',NULL,NULL,false,'FieldWorker1','User 1','P')
