...
CREATE TABLE `form` (`uuid` varchar(32) NOT NULL, `formName` varchar(255) NOT NULL, `active` varchar(50) NOT NULL DEFAULT '0', `deleted` bit(1) NOT NULL, `insertDate` date DEFAULT NULL, `voidDate` datetime DEFAULT NULL, `voidReason` varchar(255) DEFAULT NULL, `insertBy_uuid` varchar(32) DEFAULT NULL, `voidBy_uuid` varchar(32) DEFAULT NULL, `gender` varchar(255) DEFAULT NULL, `CORE_TABLE` varchar(80) DEFAULT NULL, `status` tinyint(4) NOT NULL DEFAULT '0', PRIMARY KEY (`uuid`), KEY `FK300CC497735AF9` (`insertBy_uuid`), KEY `FK300CC4A726FBE` (`voidBy_uuid`), CONSTRAINT `FK300CC497735AF9` FOREIGN KEY (`insertBy_uuid`) REFERENCES `user` (`uuid`), CONSTRAINT `FK300CC4A726FBE` FOREIGN KEY (`voidBy_uuid`) REFERENCES `user` (`uuid`) ) ENGINE=InnoDB DEFAULT CHARSET=latin1;