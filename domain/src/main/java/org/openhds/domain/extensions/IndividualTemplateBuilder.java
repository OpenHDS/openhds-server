...
public class IndividualTemplateBuilder {
	...
	public void buildIndividualTemplate(JDefinedClass jc) {
		...
		buildIndividualClassAnnotations(jc);
		buildIndividualFieldsAndMethods(jc);
		
		individualTemplateBuilt = true;
	}
	
	public void buildIndividualFieldsAndMethods(JDefinedClass jc) {
		...
		// residencies
		JFieldVar jfResidencies = jc.field(JMod.NONE , java.util.Set.class, "allResidencies");
	...
	public void buildIndividualClassAnnotations(JDefinedClass jc) {
